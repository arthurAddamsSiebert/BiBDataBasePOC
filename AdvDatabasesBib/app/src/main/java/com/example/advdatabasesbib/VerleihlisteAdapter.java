...
public class VerleihlisteAdapter extends RecyclerView.Adapter<VerleihlisteAdapter.ViewHolder> {
    ...
    public VerleihlisteAdapter(ArrayList<String> tList, ArrayList<String> yList, Context context) {
    ...
    @NonNull
    @Override
    public VerleihlisteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.book_view, viewGroup, false);
        return new VerleihlisteAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull VerleihlisteAdapter.ViewHolder viewHolder, int i) {
